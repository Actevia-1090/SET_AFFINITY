...
int main() {
    ...
    if (pid1 == 0) {
        ...
        pthread_t tid;
        pthread_create(&tid, NULL, run_in_loop, (void *)args);
	...
	char* child1 = "Child2";
        ...
        int args[] = {Thread_number, core_id};
        pthread_t tid1;
        pthread_create(&tid1, NULL, run_in_loop, (void *)args);
	...
	char* child2 = "Child3";
        ...
        int args[] = {Thread_number, core_id};
        pthread_t tid2;
        pthread_create(&tid2, NULL, run_in_loop, (void *)args);
	...
	char* child3 = "Child4";
        ...
        int args[] = {Thread_number, core_id};
        pthread_t tid3;
        pthread_create(&tid3, NULL, run_in_loop, (void *)args);
